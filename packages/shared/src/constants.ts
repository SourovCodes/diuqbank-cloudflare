// Cross-app constants: the single source of truth for upload limits, accepted
// MIME types, and pagination defaults. Imported by both the API (request
// validation) and the web app (client-side pre-checks) so the two never drift.
