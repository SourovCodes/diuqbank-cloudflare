...
/** 24×24 stroke icons (path data from lucide.dev, ISC licensed). */
function make(children: ReactNode): Icon {
...
export const FileQuestionIcon = make(
  <>
