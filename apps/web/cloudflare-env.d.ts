/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: f4ac21e14ffd865c45010745ee79591e)
// Runtime types generated with workerd@1.20260617.1 2026-06-20 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	ASSETS: Fetcher;
	API_PUBLIC_ORIGIN: "https://diuqbank.sourovcodes.workers.dev";
	API: Fetcher /* diuqbank */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_PUBLIC_ORIGIN">> {}
}
