 ...
 * Google confirms the token and its score clears MIN_SCORE. Fails closed: any
 * network/parse error (or a non-success response) resolves to `false` so a
 * broken verifier can't silently wave traffic through.
 *
