/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2eecf9e0e7b7d86c0867e90b9eb4fed4)
...
interface __BaseEnv_Env {
	...
	CF_ACCOUNT_ID: "f270c3ed6636c3aa31b1393dc34ee95c";
	AI_GATEWAY_NAME: "diuqbank";
	PDF_PROCESSOR_URL: "https://pdf-processor.diuqbank.com";
	WEB_ORIGINS: "https://diuqbank-web.sourovcodes.workers.dev,http://localhost:5173";
	JWT_SECRET: string;
	ADMIN_EMAIL: string;
	GEMINI_API_KEY: string;
	PDF_PROCESSOR_API_KEY: string;
	AUTO_SUBMISSION_WORKFLOW: Workflow<Parameters<import("./src/index").AutoSubmissionWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_CLIENT_ID" | "CF_ACCOUNT_ID" | "AI_GATEWAY_NAME" | "PDF_PROCESSOR_URL" | "WEB_ORIGINS" | "JWT_SECRET" | "ADMIN_EMAIL" | "GEMINI_API_KEY" | "PDF_PROCESSOR_API_KEY">> {}
}
